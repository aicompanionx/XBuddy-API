...
from app.services.tts import text_to_speech, optimize_text_for_tts
    ...
    try:
        ...
        if req.optimize:
            try:
                ...
                logger.warning(f"Failed to optimize text, will use the original text: {str(e)}")
        ...
        return TtsAudioResponse(code=0, msg="Audio generated successfully", data=response_data)
