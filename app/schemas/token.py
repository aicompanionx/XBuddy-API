...
class RiskOptions(BaseModel):
    ...
    can_take_back_ownership: bool = Field(False, description="Can the owner take back ownership?")
    owner_change_balance: bool = Field(False, description="Can the owner change the balance?")
    ...
    external_call: bool = Field(False, description="Is there an external contract call?")
    ...
    cannot_sell_all: bool = Field(False, description="Can the owner sell all the tokens?")
    ...
    anti_whale_modifiable: bool = Field(False, description="Is the anti-whale modifiable?")
    ...
    personal_slippage_modifiable: bool = Field(False, description="Is the personal slippage modifiable?")
    # Basic information
    ...
    top_holders_percent: Optional[float] = Field(None, description="Top 10 holders percent")
...
class SOLRiskOptions(BaseModel):
    ...
    transfer_fee_upgradable: bool = Field(False, description="Is the transfer fee upgradable?")
