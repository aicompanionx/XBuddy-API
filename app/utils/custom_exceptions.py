...
class ForbiddenException(ApiException):
    ...
    def __init__(self, message: str = "forbidden access", data: Any = None):
        super().__init__(
            status_code=status.HTTP_403_FORBIDDEN, code=403, message=message, data=data
        )
...
class NotFoundException(ApiException):
    ...
    def __init__(self, message: str = "resource not found", data: Any = None):
        super().__init__(
            status_code=status.HTTP_404_NOT_FOUND, code=404, message=message, data=data
        )
...
class ExternalApiException(ApiException):
    ...
    def __init__(
        self, message: str = "external API service unavailable", data: Any = None
    ):
        super().__init__(
